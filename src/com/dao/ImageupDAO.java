...
public class ImageupDAO {
	...
	public void setAll(TowDetailsVO towdetailsVO,LocationVO locationVO,AreaVO areaVO)
	{
		...
		Query q1 = session.createQuery("from AreaVO where id = "+towdetailsVO.getImageupvo().getAreaVO().getId());
		areaList=q1.list();
		...
		while (it1.hasNext())
		{
			 ...
			 towdetailsVO.getImageupvo().getAreaVO().setAreaName(areaVO.getAreaName());
		}
